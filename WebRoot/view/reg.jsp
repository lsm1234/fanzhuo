...
<body>
	<div class="contact" >
		<form action="reg" name="form1" method="post" >
			<ul>
				<li>
					<label>姓名：</label>
				...
				<li>
					<label>爱好：</label> 
					<input type="checkbox" name="hobby" value="5">怪兽
		  			<input type="checkbox" name="hobby" value="1">音乐
		  			<input type="checkbox" name="hobby" value="2">篮球
		  			<input type="checkbox" name="hobby" value="3">美女
				...
				<li>
					<label>自我介绍：</label> 
					<textarea rows="4" cols="39" name = "introduce"></textarea>
				</li>
				<li>
					<%String error = (String)request.getAttribute("regError");
